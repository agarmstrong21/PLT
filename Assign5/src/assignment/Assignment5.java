...
public class Assignment5 {
	...
	private ArrayList<Assignment5> branches;
	public Assignment5(int elementValue)
	{
		this.elementValue = elementValue;
		this.branches = new ArrayList<Assignment5>();
	}
	 ...
	 * @return
	 */
	public static int problem2(Assignment5 tree)
	{
	...
	public static int problem4(Assignment5 tree, IntUnaryOperator expression)
	{
	 ...
	 * @return
	 */
	public static Assignment5 problem5(int input)
	{

		// Create a new anonymous class and object of that class called myObj that extends the Assignment5 class
		Assignment5 myObj = new Assignment5(input){
		...
		// return myObj created from the anonymous class
		return myObj;
	}
	...
	public static void main(String[] args)
	{
		...
		Assignment5 myTree = new Assignment5(0);
		myTree.branches.add(new Assignment5(1));
		myTree.branches.add(new Assignment5 (2));
		myTree.branches.get(0).branches.add(new Assignment5(3));
		myTree.branches.get(0).branches.get(0).branches.add(new Assignment5(4));
		myTree.branches.get(0).branches.get(0).branches.add(new Assignment5(5));
		myTree.branches.get(0).branches.get(0).branches.get(1).branches.add(new Assignment5(6));

		System.out.println(problem2(myTree));

		Assignment5 myTree2 = new Assignment5(0);

		System.out.println(problem2(myTree2));

		Assignment5 myTree3 = new Assignment5(0);
		myTree3.branches.add(new Assignment5(1));
		myTree3.branches.add(new Assignment5(2));
		myTree3.branches.add(new Assignment5(3));
		myTree3.branches.add(new Assignment5(4));
		myTree3.branches.add(new Assignment5(5));

		System.out.println(problem2(myTree3));

		Assignment5 myTree4 = new Assignment5(0);
		myTree4.branches.add(new Assignment5(1));
		myTree4.branches.get(0).branches.add(new Assignment5(2));
		myTree4.branches.get(0).branches.get(0).branches.add(new Assignment5(3));
		myTree4.branches.get(0).branches.get(0).branches.get(0).branches.add(new Assignment5(4));
		myTree4.branches.get(0).branches.get(0).branches.get(0).branches.get(0).branches.add(new Assignment5(5));

		Assignment5 myTree5 = new Assignment5(0);
		myTree5.branches.add(new Assignment5(-1));
		myTree5.branches.add(new Assignment5(-2));
		myTree5.branches.add(new Assignment5(-3));
		myTree5.branches.add(new Assignment5(-4));
		myTree5.branches.add(new Assignment5(-5));

		System.out.println(problem2(myTree3));

		Assignment5 myTree6 = new Assignment5(0);
		myTree6.branches.add(new Assignment5(-1));
		myTree6.branches.get(0).branches.add(new Assignment5(-2));
		myTree6.branches.get(0).branches.get(0).branches.add(new Assignment5(-3));
		myTree6.branches.get(0).branches.get(0).branches.get(0).branches.add(new Assignment5(-4));
		myTree6.branches.get(0).branches.get(0).branches.get(0).branches.get(0).branches.add(new Assignment5(-5));
