...
public class Assignment4 implements Comparable<Object>
{
	...
	public boolean equals(Object myObj){
		...
		Assignment4 object = (Assignment4) myObj;
	...
	public int compareTo(Object value){
		...
		Assignment4 myObj = (Assignment4) value;
	...
	public static void main(String[] args)
	{
		...
		//Problem 4
		HashSet<Assignment4> myHashSet = new HashSet<Assignment4>();
		for(int index = 0; index < 10; index++){
			myHashSet.add(new Assignment4(index));
		}
		Iterator<Assignment4> myIter = myHashSet.iterator();
		while(myIter.hasNext()){
			Assignment4 myAssign = myIter.next();
		...
		//Problem 5
		Assignment4 myObj = new Assignment4(5);
		Object myObj2 = new Assignment4(6);
		System.out.println(myObj.equals(myObj2));

		//Problem 6
		ArrayList<Assignment4> myAssign = new ArrayList<Assignment4>();
		for(int i = 0; i < 10; i++){
			myAssign.add(new Assignment4(i));
		}
